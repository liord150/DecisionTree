1. DecisionTreeImpl(DataSet train) - this is a recursive function, built according to figure 18.5, returns a decision tree.
...
String getMaxIgAtt(List<Instance> instances, List<String> attributes) -
first calculates entropy of the root using entropyRoot.
...
2. classify (Instance) - Recursive function that travels on the decision tree, according to the instance attributes values.
...
4. printAccuracy - this methods prints the DTL accuracy.
